...
const MobileNavClient = ({session}: {session: any}) => {
            ...
            {!session ?  (
              ...
              <>
                ...
                <button 
                  ...
                  className="text-right text-2xl font-bold mb-4 border-b-2 border-gray-200 hover:text-orange-500 transition-colors duration-200"
                >
                  Logout
                </button>
              </>
